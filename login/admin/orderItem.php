                    ...
                    <div style="max-height: 45rem;overflow-y: auto;">
                        ...
                        if (isset($_POST['search'])) {
                            if (!empty($_POST['search'])) {
                                ...
                                $query = "SELECT * FROM Menu WHERE item_type LIKE '%$search%' OR item_name LIKE '%$search%' OR item_id LIKE '%$search%' ORDER BY item_id;";
            ...
            <tr>
                ...
                <td>RS <?php echo number_format(($tax * $cart_total) + $cart_total, 2); ?></td>
                        ...
                        if ($has_payment_time) {
                           ...
                           echo '<a href="posCashPayment.php?bill_id=' . $bill_id . '" class="btn btn-success">Cash</a><br><br>';
                           echo '<a href="posCardPayment.php?bill_id=' . $bill_id .  '" class="btn btn-primary ml-2">Credit Card</a>';
                        } else {
