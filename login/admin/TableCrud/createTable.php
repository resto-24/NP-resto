...
<form method="POST" action="succ_create_table.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input min="1" type="number" name="table_id" placeholder="1" class="form-control <?php echo $next_table_id ? 'is-invalid' : ''; ?>" id="next_table_id" required value="<?php echo $next_table_id; ?>" readonly><br>
        ...
        <div class="form-group">
           <br> <a href="../table-panel.php">Back</a>
        </div>   
